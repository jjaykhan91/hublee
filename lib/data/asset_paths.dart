...
class AssetPaths {
  ...
  /// Per-surah word-by-word English glosses:
  /// `assets/quran/en.wordbyword/<surahId>.json`.
  ///
  /// Generated by `tools/build_word_by_word.dart`, which guarantees one gloss
  /// per word of the standard Uthmani text in `ar/<surahId>.json`.
  static String quranWordByWordEnglish(int surahId) =>
      '$quranRoot/en.wordbyword/$surahId.json';
