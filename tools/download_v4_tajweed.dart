...
Future<void> main(List<String> args) async {
  final parser = ArgParser()
    ..addFlag('fonts-only',
        defaultsTo: false, help: 'Only download fonts (skip script reminder).')
    ..addFlag('script-only',
        defaultsTo: false, help: 'Only print script download instructions.');
  ...
  final fontDir = Directory(p.join(projectRoot, 'assets', 'fonts', 'qpc_v4_tajweed'));
